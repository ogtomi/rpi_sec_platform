...
all: server.o client.o s_socket.o c_socket.o m_socket.o
	${CXX} ${CXX_FLAGS} server.o s_socket.o m_socket.o -o ${OUT_SERVER}
	${CXX} ${CXX_FLAGS} client.o c_socket.o m_socket.o -o ${OUT_CLIENT}
